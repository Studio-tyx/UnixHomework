...
/* Define constant */
const unsigned MysBUF_SIZE = 1 << 10; /* Fixed string buffer length */
const unsigned MysMAX_NAME_LEN = 1 << 8; /* Maximum string name length */
const unsigned MysRX_BUF_SIZE = 1 << 12; /* Default receive buffer size */
const unsigned MysTX_BUF_SIZE = 1 << 12; /* Default transmit buffer size */
...
protected: /*Socket variables*/
	...
	int protocol_family; /* Object's protocol */
	int socket_type; /* Object's socket type: SOCK_STREAM SOCK_DGRAM */
